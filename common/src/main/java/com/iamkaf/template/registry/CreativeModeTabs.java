...
public class CreativeModeTabs {
    private static final DeferredRegister<CreativeModeTab> TABS =
            DeferredRegister.create(Reference.MOD_ID, Registries.CREATIVE_MODE_TAB);

    public static final RegistrySupplier<CreativeModeTab> TEMPLATE = TABS.register(
            Reference.MOD_ID, () -> CreativeTabRegistry.create(
                    Component.translatable("creativetab." + Reference.MOD_ID + "." + Reference.MOD_ID),
